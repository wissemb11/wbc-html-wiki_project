...
full_atts={}
for (k in {...tags,...attrs_html_by_browser})
    {
        console.log(k)
        full_atts[k]={browser:{},attrs:{},...tags[k],...attrs_html_by_browser[k]}
        for (k_k in attrs_html_by_browser[k]?.['attrs']||{})
        {
            console.log(k_k)
            full_atts[k]['attrs'][k_k].concern=all_attrs?.[k_k]?.concern||[]
            full_atts[k]['attrs'][k_k].desc=all_attrs?.[k_k]?.desc||''
            full_atts[k]['attrs'][k_k].note=all_attrs?.[k_k]?.note||''
        }

    }


console.log(full_atts);