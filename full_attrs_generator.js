...
//     },
//     value: {
//         concern: ['button', 'input', 'li', 'option', 'meter', 'progress', 'param'],
...
import html_tags from "./htmlSource/html_tags"
import all_attrs from "./htmlSource/all_attrs"
import attrs_html_by_browser from "./htmlSource/attrs_html_by_browser"

full_attrs={}
for (k in {...html_tags,...attrs_html_by_browser})
    {
        console.log(k)
        full_attrs[k]={browser:{},attrs:{},...html_tags[k],...attrs_html_by_browser[k]}
        for (k_k in attrs_html_by_browser[k]?.['attrs']||{})
        {
            console.log(k_k)
            full_attrs[k]['attrs'][k_k].concern=all_attrs?.[k_k]?.concern||[]
            full_attrs[k]['attrs'][k_k].desc=all_attrs?.[k_k]?.desc||''
            full_attrs[k]['attrs'][k_k].note=all_attrs?.[k_k]?.note||''
        }

    }


console.log(full_attrs);